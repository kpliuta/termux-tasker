...
class LogTestApp(App):
    def compose(self) -> ComposeResult:
        ...
        yield Button("Show Long Line (Wrap Off)", id="wrap_off")
        yield Button("Show Long Line (Wrap On)", id="wrap_on")
    ...
    @on(Button.Pressed, "#wrap_off")
    def show_wrap_off(self) -> None:
        self.push_screen(LogScreen(content=_LONG_LINE, soft_wrap=False))

    @on(Button.Pressed, "#wrap_on")
    def show_wrap_on(self) -> None:
        self.push_screen(LogScreen(content=_LONG_LINE, soft_wrap=True))
